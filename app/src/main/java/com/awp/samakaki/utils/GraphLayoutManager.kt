...
abstract class GraphLayoutManager internal constructor(context: Context)
    ...
    private var adapter: com.awp.samakaki.utils.AbstractGraphAdapter<*>? = null
    ...
    override fun onAdapterChanged(oldAdapter: RecyclerView.Adapter<*>?,
        ...
        if (newAdapter !is com.awp.samakaki.utils.AbstractGraphAdapter) {
            throw RuntimeException(
                "GraphLayoutManager only works with ${com.awp.samakaki.utils.AbstractGraphAdapter::class.simpleName}")
        }
     ...
     */
    abstract fun run(graph: com.awp.samakaki.utils.Graph, shiftX: Float, shiftY: Float): com.awp.samakaki.utils.Size
