...
import com.qatros.samakaki.databinding.CardviewInvitationNotificationBinding
...
class NotificationsAdapter (private var list: List<UnreadItem>, val context: Context) : RecyclerView.Adapter<NotificationsAdapter.NotificationsViewHolder>() {
    ...
    override fun onBindViewHolder(holder: NotificationsViewHolder, position: Int) {
        ...
        val spinnerData = context.resources.getStringArray(com.qatros.samakaki.R.array.relation)
