...
abstract class GraphLayoutManager internal constructor(context: Context)
    ...
    private var adapter: com.qatros.samakaki.utils.AbstractGraphAdapter<*>? = null
    ...
    override fun onAdapterChanged(oldAdapter: RecyclerView.Adapter<*>?,
        ...
        if (newAdapter !is com.qatros.samakaki.utils.AbstractGraphAdapter) {
            throw RuntimeException(
                "GraphLayoutManager only works with ${com.qatros.samakaki.utils.AbstractGraphAdapter::class.simpleName}")
        }
     ...
     */
    abstract fun run(graph: com.qatros.samakaki.utils.Graph, shiftX: Float, shiftY: Float): com.qatros.samakaki.utils.Size
