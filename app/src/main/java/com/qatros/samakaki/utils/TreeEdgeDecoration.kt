...
open class TreeEdgeDecoration constructor(private val linePaint: Paint = Paint(Paint.ANTI_ALIAS_FLAG).apply {
    ...
    override fun onDraw(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        if (adapter !is com.qatros.samakaki.utils.AbstractGraphAdapter) {
            throw RuntimeException(
                "TreeEdgeDecoration only works with ${com.qatros.samakaki.utils.AbstractGraphAdapter::class.simpleName}")
        }
        val layout = parent.layoutManager
        if (layout !is com.qatros.samakaki.utils.BuchheimWalkerLayoutManager) {
            throw RuntimeException(
                "TreeEdgeDecoration only works with ${com.qatros.samakaki.utils.BuchheimWalkerLayoutManager::class.simpleName}")
        }
            ...
            for (node in nodes) {
                ...
                for (child in children) {
                    ...
                    when (configuration.orientation) {
                        com.qatros.samakaki.utils.BuchheimWalkerConfiguration.ORIENTATION_TOP_BOTTOM -> {
                        ...
                        com.qatros.samakaki.utils.BuchheimWalkerConfiguration.ORIENTATION_BOTTOM_TOP -> {
                        ...
                        com.qatros.samakaki.utils.BuchheimWalkerConfiguration.ORIENTATION_LEFT_RIGHT -> {
                        ...
                        com.qatros.samakaki.utils.BuchheimWalkerConfiguration.ORIENTATION_RIGHT_LEFT -> {
